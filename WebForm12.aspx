<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WebForm12.aspx.cs" Inherits="E_COMMERCE_SITE.WebForm12" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="font-size: 50px; text-align: center; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif">
        MOBILE AND COMPUTER UPLOAD SECTION
    </div>
    <div style="display: flex; justify-content: center; margin-top: 100px;">
        ...
        <table border="4">
            ...
            <tr>
                <td>
                    <b style="font-size: 25px">ENTER PRODUCT SELLER</b>
                </td>
                <td>
                    <asp:TextBox runat="server" ID="pr_seller" Width="300px" Height="50px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                    <b style="font-size: 25px">ENTER PRODUCT OS</b>
                </td>
                <td>
                    <asp:TextBox runat="server" ID="pr_os" Width="300px" Height="50px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
