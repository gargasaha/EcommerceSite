    ...
    public partial class WebForm17 : System.Web.UI.Page
    {
        ...
        protected void submit(object sender, EventArgs e)
        {
            ...
            if (b1 == null && b2 == null && b3 == null)
            {
                ...
                string name, desp,publisher;
                double price;
                int stock;
                name = pr_name.Text.ToString();
                desp = pr_desp.Text.ToString();
                publisher= pr_publisher.Text.ToString();
                ...
                sqlConnection.Open();
                SqlCommand cmd = new SqlCommand("insert6", sqlConnection);
                ...
                cmd.Parameters.AddWithValue("pr_publisher", publisher);
